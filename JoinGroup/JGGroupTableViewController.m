...
@interface JGGroupTableViewController ()

@end

@implementation JGGroupTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ members, %@ verified activities", [object objectForKey:@"MemberCount"], [object objectForKey:@"ActivityCount"]];
    ...
    goldenColor.backgroundColor = [UIColor colorWithRed:0.824 green:0.749    blue:0.553 alpha:1];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIStoryboard *myStoryboard = self.stb;
    JGGroupDetailViewController *detailViewController = [myStoryboard instantiateViewControllerWithIdentifier:@"GroupDetailsID"];
    NSInteger index = [self.tableView.indexPathForSelectedRow row];
    detailViewController.groupItems = [self.objects objectAtIndex:index];
    [self.groupViewController presentModalViewController:detailViewController animated:YES];
}
